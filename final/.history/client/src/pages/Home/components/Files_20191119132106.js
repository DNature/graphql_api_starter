...
const Files = props => {
  const { classes } = props;
  const { data: { singleFile = {} } = {} } = useQuery(UPLOADS_QUERY);
          ...
          <Card>
            ...
            <CardContent>
              <Typography variant="body2" component="p">
                ...
                Dicta pariatur atque consectetur dignissimos architecto ducimus
                minima fuga veniam quae aliquid.
              </Typography>
            </CardContent>
          </Card>
